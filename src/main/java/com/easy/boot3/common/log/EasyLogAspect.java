...
import com.easy.boot3.admin.operationLog.enums.RoleTypeEnum;
import com.easy.boot3.admin.operationLog.service.IOperationLogService;
import com.easy.boot3.common.base.Result;
import com.easy.boot3.common.properties.EasyLogFilter;
...
public class EasyLogAspect {
    ...
    @Resource
    private com.easy.boot3.common.properties.EasyLog easyLog;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(com.easy.boot3.common.log.EasyLog)")
