...
public class FastJobManager {
    ...
    public void startNowJob(StartNowJobDTO dto, ScheduledTask task) {
        try {
            ...
            // 任务名称和组构成任务实例
            JobDetail jobDetail = JobBuilder.newJob(FastJobTaskExecute.class)
