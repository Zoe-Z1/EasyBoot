    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(url, "root", "zz123456")
                ...
                .packageConfig(builder -> {
                    String xmlPath = outputDir + "/com/fast/start/resource";
                    builder.parent("com.fast.start.admin") // 设置父包名
                            .entity("entity")
                ...
                .injectionConfig(consumer -> {
                    ...
                    customMap.put("querySuperEntityPackage", "com.fast.start.common.base");
