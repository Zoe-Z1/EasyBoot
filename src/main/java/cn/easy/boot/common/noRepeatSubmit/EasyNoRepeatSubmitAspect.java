...
public class EasyNoRepeatSubmitAspect {
    ...
    @Resource
    private cn.easy.boot.common.properties.EasyNoRepeatSubmit easyNoRepeatSubmit;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot.common.noRepeatSubmit.EasyNoRepeatSubmit)")
     ...
     * 配置织入点
     */
    @Pointcut("execution(public * cn.easy.boot.*.*.controller..*(..))")
