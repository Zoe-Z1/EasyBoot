package cn.easy.boot.common.log;
...
import cn.easy.boot.common.properties.EasyLogFilter;
...
public class EasyLogAspect {
    ...
    @Resource
    private cn.easy.boot.common.properties.EasyLog easyLog;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot.common.log.EasyLog)")
