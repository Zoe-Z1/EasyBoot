package cn.easy.boot3.common.noRepeatSubmit;
...
public class EasyNoRepeatSubmitAspect {
    ...
    @Resource
    private cn.easy.boot3.common.properties.EasyNoRepeatSubmit easyNoRepeatSubmit;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot3.common.noRepeatSubmit.EasyNoRepeatSubmit)")
     ...
     * 配置织入点
     */
    @Pointcut("execution(public * cn.easy.boot3.*.*.controller..*(..))")
