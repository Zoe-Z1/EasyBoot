package cn.easy.boot3.common.log;

import cn.easy.boot3.common.properties.EasyLogFilter;
...
public class EasyLogAspect {
    ...
    @Resource
    private cn.easy.boot3.common.properties.EasyLog easyLog;
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot3.common.log.EasyLog)")
