package cn.easy.boot3.common.redisson;

import cn.hutool.core.util.StrUtil;
import cn.easy.boot3.common.redis.RedisKeyEnum;
import cn.easy.boot3.exception.LockException;
...
public class EasyLockAspect {
    ...
    @Resource
    private cn.easy.boot3.common.properties.EasyLock globalEasyLock;

    /**
     * 配置织入点
     */
    @Pointcut("@annotation(cn.easy.boot3.common.redisson.EasyLock)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        cn.easy.boot3.common.properties.EasyLock lock = this.getLock(annotation, method, args);
     ...
     * @return
     */
    private cn.easy.boot3.common.properties.EasyLock getLock(EasyLock easyLock, Method method, Object[] args) {
        ...
        return cn.easy.boot3.common.properties.EasyLock.builder()
                .leaseTime(leaseTime)
                .waitTime(waitTime)
                .build();
    }
